...
public class DrinkItem extends Item {
    ...
    private DrinkItemManager manager;

    public DrinkItem(Properties pProperties) {
        super(pProperties);
    }

    public DrinkItemManager getManager() {
        return manager;
    }

    public DrinkItem setManager(DrinkItemManager manager) {
    ...
    public @NotNull ItemStack finishUsingItem(@NotNull ItemStack stack, @NotNull Level level, @NotNull LivingEntity entity) {
        ...
        //具体实现在mixin/thirstwastaken/MixinPlayerThirst.java中
        ...
        if ((manager != null && manager.getContainer() != null) && !player.getAbilities().instabuild) {
            ItemStack container = manager.getContainer().stack();
